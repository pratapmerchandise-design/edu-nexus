...
const replacements = [
  // Backgrounds
  { regex: /bg-\[#(0e1410|121914|0e1511|111813)\]/g, replacement: 'bg-card' },
  { regex: /bg-\[#(131b16|131c16|141d17|0b100d)\]/g, replacement: 'bg-secondary' },
  { regex: /bg-\[#(050706|070b08)\]/g, replacement: 'bg-background' },
  { regex: /bg-\[#22e079\]\/10/g, replacement: 'bg-primary/10' },
  { regex: /bg-\[#22e079\]\/20/g, replacement: 'bg-primary/20' },
  ...
  { regex: /text-\[#(7d8b82|8e9c93|829186|6e7b72|647269|78887e|5d6a61|6b7970|6d7971|9ca6a0|839288|aeb8b2|738077|5c6861)\]/g, replacement: 'text-muted-foreground' },
